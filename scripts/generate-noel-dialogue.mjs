...
const sourceUrl = new URL('../chat/noel/player/dialogue.txt', import.meta.url);
...
const generated = `// Generated from chat/noel/player/dialogue.txt. Run npm run generate:noel-dialogue after editing it.\nexport const NOEL_DIALOGUE_LINES = ${JSON.stringify(lines, null, 2)} as const;\n`;

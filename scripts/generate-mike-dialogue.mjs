...
const sourceUrl = new URL('../chat/mike/player/dialogue.txt', import.meta.url);
...
const generated = `// Generated from chat/mike/player/dialogue.txt. Run npm run generate:mike-dialogue after editing it.\nexport const MIKE_DIALOGUE_LINES = ${JSON.stringify(lines, null, 2)} as const;\n`;

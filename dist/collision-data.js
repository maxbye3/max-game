...
import { ROAD_BUS_ROOF_WIDTH, ROAD_BUS_ROOF_X, ROAD_BUS_SIGN_HEIGHT, ROAD_BUS_SIGN_SOURCE_X, ROAD_BUS_SIGN_SOURCE_Y, ROAD_BUS_SIGN_WIDTH, ROAD_X, ROAD_Y, } from './config.js';
...
const MAP_COLLISION_SHAPES = COLLISION_CUTOUTS.reduce((shapes, cutout) => shapes.flatMap((shape) => subtractCollisionShape(shape, cutout)), [...RAW_COLLISION_SHAPES]);
...
const WESTERN_GARDEN_COLLISION_SHAPES = [
    [152, 576, 88, 40],
    [272, 576, 80, 40],
    [152, 576, 32, 272],
    [328, 576, 24, 272],

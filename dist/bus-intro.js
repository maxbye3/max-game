import { BUS_INTRO_BUS_BASELINE_Y, BUS_INTRO_CAMERA_Y, BUS_INTRO_PLAYER_END_Y, BUS_INTRO_PLAYER_START_Y, BUS_INTRO_STOP_X, FRAME_COUNT, } from './config.js';
...
const skipButton = document.querySelector('#bus-intro-skip');
...
export function isBusIntroActive() {
    return active;
}
export function isBusIntroPlayerVisible() {
    return !active || elapsed >= DRIVE_IN_END;
}
export function getBusIntroCameraCenter() {
...
export function updateBusIntro(deltaTime, player) {
    if (!active)
        return;
...
//# sourceMappingURL=bus-intro.js.map
...
(() => {
  ...
  var noelTheme = new Audio("../chat/noel/example_character/theme.mp3");
  ...
  bindControls();
  Promise.all([interior.decode(), collisionMask.decode(), doorOverlay.decode(), spriteSheet.decode(), noelSprite.decode()]).then(() => {
